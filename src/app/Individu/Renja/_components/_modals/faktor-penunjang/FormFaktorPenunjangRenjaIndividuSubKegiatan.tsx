...
interface FormFaktorPenunjangRenjaIndividuSubKegiatanProps {
  kodeOpd: string;
  kode: string;
...
const ENDPOINT = '/api/v1/realisasi/renja_individu/subkegiatan/faktor-penunjang';
const KODE_FIELD = 'kodeSubKegiatan';

const FormFaktorPenunjangRenjaIndividuSubKegiatan: React.FC<FormFaktorPenunjangRenjaIndividuSubKegiatanProps> = ({
  kodeOpd,
  kode,
  kodeIndikator,
  kodeTarget,
...
export default FormFaktorPenunjangRenjaIndividuSubKegiatan;
