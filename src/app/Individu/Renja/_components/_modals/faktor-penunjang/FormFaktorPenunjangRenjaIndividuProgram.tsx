...
interface FormFaktorPenunjangRenjaIndividuProgramProps {
  kodeOpd: string;
  kode: string;
...
const ENDPOINT = '/api/v1/realisasi/renja_individu/program/faktor-penunjang';

const FormFaktorPenunjangRenjaIndividuProgram: React.FC<FormFaktorPenunjangRenjaIndividuProgramProps> = ({
  kodeOpd,
  kode,
  kodeIndikator,
  kodeTarget,
...
export default FormFaktorPenunjangRenjaIndividuProgram;
