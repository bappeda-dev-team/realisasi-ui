...
interface FormFaktorPenunjangRenjaIndividuKegiatanProps {
  kodeOpd: string;
  kode: string;
...
const ENDPOINT = '/api/v1/realisasi/renja_individu/kegiatan/faktor-penunjang';
const KODE_FIELD = 'kodeKegiatan';

const FormFaktorPenunjangRenjaIndividuKegiatan: React.FC<FormFaktorPenunjangRenjaIndividuKegiatanProps> = ({
  kodeOpd,
  kode,
  kodeIndikator,
  kodeTarget,
...
export default FormFaktorPenunjangRenjaIndividuKegiatan;
