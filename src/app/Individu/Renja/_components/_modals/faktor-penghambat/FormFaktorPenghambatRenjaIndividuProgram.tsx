...
interface FormFaktorPenghambatRenjaIndividuProgramProps {
  kodeOpd: string;
  kode: string;
...
const ENDPOINT = '/api/v1/realisasi/renja_individu/program/faktor-penghambat';
const KODE_FIELD = 'kodeProgram';

const FormFaktorPenghambatRenjaIndividuProgram: React.FC<FormFaktorPenghambatRenjaIndividuProgramProps> = ({
  kodeOpd,
  kode,
  kodeIndikator,
  kodeTarget,
...
export default FormFaktorPenghambatRenjaIndividuProgram;
