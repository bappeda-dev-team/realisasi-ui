...
interface FormFaktorPenghambatRenjaIndividuSubKegiatanProps {
  kodeOpd: string;
  kode: string;
...
const ENDPOINT = '/api/v1/realisasi/renja_individu/subkegiatan/faktor-penghambat';
const KODE_FIELD = 'kodeSubKegiatan';

const FormFaktorPenghambatRenjaIndividuSubKegiatan: React.FC<FormFaktorPenghambatRenjaIndividuSubKegiatanProps> = ({
  kodeOpd,
  kode,
  kodeIndikator,
  kodeTarget,
...
export default FormFaktorPenghambatRenjaIndividuSubKegiatan;
