...
const KegiatanTable = () => {
    ...
    const [laporanPdfFileName, setLaporanPdfFileName] = useState('laporan-realisasi-renja-kegiatan.pdf');
    ...
    const handleGenerateLaporan = async (jenisLaporan: string) => {
        const baseUrl = `/api/v1/realisasi/renja_individu/kegiatan/laporan/nip/${encodeURIComponent(effectiveNip || '')}/kodeOpd/${encodeURIComponent(effectiveKodeOpd || '')}/tahun/${encodeURIComponent(activatedTahun || '')}/jenisLaporan/${jenisLaporan}`;
        ...
        doc.setFontSize(14);
        doc.text(`Laporan Realisasi Renja Individu (Kegiatan) - ${jenisLaporan}`, 40, 40);
        ...
        setLaporanPdfFileName(`laporan-realisasi-renja-kegiatan-${jenisLaporan.toLowerCase()}-${activatedTahun}.pdf`);
        ...
        <>
            ...
            {isLaporanPreviewOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <div className="relative z-10 w-[95vw] max-w-6xl rounded-lg bg-white p-4 shadow-lg">
                        <div className="mb-3 border-b pb-2">
                            <h2 className="text-lg font-semibold uppercase">Preview Laporan Realisasi Renja Individu (Kegiatan)</h2>
                            <p className="text-sm text-gray-600">Periksa tampilan sebelum mengunduh PDF.</p>
                        </div>
