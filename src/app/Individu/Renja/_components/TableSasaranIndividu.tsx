...
import RowSasaranIndividu from "./RowSasaranIndividu";

interface TableSasaranIndividuProps {
    tahun: string;
    bulanLabel?: string;
...
export default function TableSasaranIndividu({
    tahun,
    bulanLabel,
    sasaranIndividu,
    canEdit,
