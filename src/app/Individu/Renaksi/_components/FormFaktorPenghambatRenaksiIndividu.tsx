...
interface FormFaktorPenghambatRenaksiIndividuProps {
    renaksiId: string;
    targetId: string;
    tahun: string;
    bulan: string;
...
const FormFaktorPenghambatRenaksiIndividu: React.FC<FormFaktorPenghambatRenaksiIndividuProps> = ({
    renaksiId,
    targetId,
    tahun,
    bulan,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const res = await fetch(`${url}/api/v1/realisasi/renaksi/faktor-penghambat`, {
                method: 'POST',
                headers: {
...
export default FormFaktorPenghambatRenaksiIndividu;
