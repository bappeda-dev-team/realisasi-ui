...
export default function TableLaporanRenjaOpd({ laporanType }: { laporanType?: string }) {
    ...
    if (laporanType && activatedTahun && activatedDinas) {
        ...
        fetchUrl = `/api/v1/realisasi/renja_opd/laporan/kodeOpd/${kodeOpd}/tahun/${tahun}/jenisLaporan/${jenisLaporan}${queryString ? `?${queryString}` : ''}`;
    }
            ...
            <table className="w-full">
                ...
                <tbody>
                    {loading ? (
                        ...
                        <tr>
                            <td colSpan={isTahunan ? 16 : isTriwulan ? 8 : 4} className="text-center py-4 text-gray-500">Pilih laporan realisasi agar data laporan renja opd muncul.</td>
                        </tr>
