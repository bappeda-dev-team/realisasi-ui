            ...
            <table className="w-full">
                <thead>
                    <tr className="text-white bg-red-400">
                        ...
                        <th rowSpan={2} className="border-r border-b py-4 px-6 border-gray-300 min-w-[200px] text-center">Tema</th>
                        <th rowSpan={2} className="border-r border-b py-4 px-6 border-gray-300 min-w-[200px] text-center">Tujuan</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td rowSpan={3} className="border border-red-400 px-6 py-4 text-center">Tema</td>
                    </tr>
                    <tr>
